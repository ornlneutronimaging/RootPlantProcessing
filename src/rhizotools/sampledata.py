...
def sampledata(wd, unittest=0):  # noqa: C901
    """
    'sampleimages' generates a suite of images: a sample spiral image,
    a 'raw' version of the reference image divided into 6 individual images,
    and a sample dark field and open beam image.
    This also creates a sample 'user_config' text file to analyze this dummy data.
    Set 'unittest' to 1 if using this for a unit test.
    """
